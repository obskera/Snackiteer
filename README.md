...
- [docs/tools/TILE_MATRIX_EDITOR.md](docs/tools/TILE_MATRIX_EDITOR.md) — tile matrix room template editor guide
- [docs/tools/TILE_MATRIX_SPEC.md](docs/tools/TILE_MATRIX_SPEC.md) — tile matrix JSON format spec
- [docs/ai/TILE_MATRIX_AI_QUICKSTART.md](docs/ai/TILE_MATRIX_AI_QUICKSTART.md) — AI quickstart for room template generation
